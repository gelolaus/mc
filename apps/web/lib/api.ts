export type Server = { host:string;online:boolean;playersOnline:number|null;playersMax:number|null;version:string|null;serverStartedAt:string|null;lastHeartbeatAt:string|null;uptimeSeconds:number|null;worldCreatedAt:string;worldAgeSeconds:number };
