...
export class JoinDto { @IsUUID() uuid!: string; @IsString() username!: string; @IsDateString() joinedAt!: string; @IsOptional() @IsIn(serverKeys) serverKey?: string; @IsOptional() @IsString() skinTextureHash?: string; }
...
export class PlayerServerDto { @IsUUID() uuid!: string; @IsString() username!: string; @IsIn(serverKeys) serverKey!: string; @IsDateString() connectedAt!: string; }
